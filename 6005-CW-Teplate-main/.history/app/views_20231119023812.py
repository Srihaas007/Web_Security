...
def reviewItem(userId, itemId):
    ...
    if request.method == "POST":
        ...
        if image_file and allowed_file(image_file.filename):
            ...
            # Store 'image_path' along with other review details in your database

        # Database logic for saving the review
        # ...
    ...
    # Handle GET request
    # Fetch the product and existing review details
    # Assuming you have a function query_db() to interact with your database
