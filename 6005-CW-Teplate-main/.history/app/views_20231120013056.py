...
UPLOAD_FOLDER = 'C:/Users/sriha/Desktop/6005-CW-Teplate-main (1)/6005-CW-Teplate-main/app/user_review_img'
    ...
    if request.method == "POST":
        ...
        if file and allowed_file(file.filename):
            ...
            if reviewId:
                ...
                VALUES ({userId}, {itemId}, {reviewStars}, '{reviewComment}', '{file_path}');
                """
